...
class Poskeu extends CI_Controller {

	function __construct()
	{
		parent::__construct();
		$this->load->model('Model_poskeu');
	...
	{	
		...
		{			
			...
			$data['posakun']=$this->Model_poskeu->tampil_posakun();
			$data['lr'] = $this->Model_pmodal->total_labarugi($data);
		...
		$this->load->view('admin/master-data/laporan/posisi_keuangan',$data);
	...
	public function cetak_poskeu()
	{
		...
		$this->load->view('laporan/laporan_posisikeuangan', $data);
