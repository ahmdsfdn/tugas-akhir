...
class Labarugi extends CI_Controller {
	...
	public function jurnal_penutup(){
		...
		$this->load->view('templates/adm_sidebar',$data);
		$this->load->view('templates/adm_header',$data);
		$this->load->view('admin/master-data/laporan/jurnal_penutup',$data);
		$this->load->view('templates/adm_footer');
		$this->load->view('templates/dash_footer');
	}
	public function cetak_penutup()
		{	
			...
			$this->load->view('laporan/laporan_jpenutup', $data);
			...
			$this->dompdf->load_html($html);
			$this->dompdf->render();
			$this->dompdf->stream("jurnal_penutup.pdf", array('Attachment' => 0));
		}
}
