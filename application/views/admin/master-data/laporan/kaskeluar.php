...
<div class="mb-2 p-2 row justify-content-center">
	<div class="col">
		
			<div class="row">
				<div class="col  text-center">
					<h3 class="font-weight-bold">Kas Keluar</h3>
				</div>
			</div>
			<div class="row">
				<div class="col text-center">
...
<div class="row mb-2 px-2">
	<div class="col">
          	...
          	<div class="row mb-2">
          		...
          		<div class="col-6 col-sm-6 col-md-3 col-xl-1">
				        	<a class="btn btn-success" href="<?= base_url();?>master/kas_keluar">Reset</a>
				</div>
		...
		<div class="row">
			<div class="col">
				<div class="table-responsive text-center ">
					  <table class="table table-bordered justify-content-center align-self-center" id="dataTable">
					  	<thead>
						  	<th>No</th>
					  		...
					  		<?php foreach ($kas_keluar as $kk): ?>
					  			...
					  			<?php else: ?>
					  				<?php if ($kk['kredit'] > 0): ?>
										...
										<?php if ($user['role_id'] == 2): ?>
											<?php if (is_null($kk['id_sewa'])): ?>

										  		<td class="align-items-center">
								  				<a href="<?= base_url(); ?>admin/ubahTransaksi/<?= $kk['bukti_transaksi']; ?>" class="btn btn-sm mr-1 btn-success mb-1 mb-xl-0"><i class="fa fa-pen"></i></a>
								  				<a href="<?= base_url(); ?>admin/hapusTransaksi/<?= $kk['bukti_transaksi'];?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
								  				</td>
										  	...
										  	<?php else: ?>
										  		...
										  		<td class="align-items-center">
								  				<a href="<?= base_url(); ?>data_sewa/update_ju/<?= $kk['id_sewa']; ?>" class="btn btn-sm mr-1 btn-primary mb-1 mb-xl-0"><i class="fa fa-pen"></i></a>
								  				<a href="<?= base_url(); ?>data_sewa/hapusdata_ju/<?= $kk['id_sewa'];?>" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>
								  				</td>				  		
