		...
		<div class="col">
				<div class="row">
					<div class="col my-2 text-center">
						<h2 class="font-weight-bold">Data Kendaraan Kembali</h2>
				...
				<hr class="m-0">
						...
						<div class="row py-2">
							...
							<div class="col-6 col-sm-6 col-md-3 col-xl-1 mb-2 mb-md-2 mb-xl-0">
								<a class="btn btn-dark" href="<?= base_url('data_sewa/cetak_dk') ?>">Cetak</a>
							</div>
...
<div class="row mb-4">
	<div class="col-12 mb-2 mb-md-0 col-md-6 col-xl-3">
		<a style="width: 100%;" href="<?= base_url() ?>data_sewa" class="btn btn-secondary shadow">Data Sewa</a>
	</div>
	<?php if ($user['role_id'] == 2): ?>
...
<div class="row justify-content-center">
	<div class="col">
		...
		<?php endif ?>
			...
			<div class="card row mb-4 shadow">
