  ...
  <h1 class="h3 mb-4 text-gray-800 text-center">Daftar Mobil</h1>
	<div class="row">
		...
		<div class="col-12 col-xl-4 mb-2 mb-xl-0">
			<div class="card">
				<form action="<?= base_url('data_sewa/tambah_mobil') ?>" method="post" name="formmobil">

					<div class="card-body mx-5 text-center">

						<label class="row">	
						<div class="col">Nama Kendaraan</div>
						</label>
						<div class="form-row">
							<div class="col-12">
								<div class="form-group">
									<input class="form-control" type="text" name="nama" value=""></input>
								</div>
							</div>
						</div>
						...
						<div class="form-row">
							<div class="col-12">
								<div class="form-group">
									<input class="form-control" type="text" name="plat"></input>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="row">
						<div class="col">
							<button type="submit" class="btn btn-success" style="width: 100%; border-radius: 0px 0px 4px 4px;">INPUT</button>
						</div>
					</div>
				</form>
			</div>
